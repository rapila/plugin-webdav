...
/**
 * Base class that represents a row from the 'directory_permissions' table.
 *
 * 
 *
 * @package    propel.generator.model.om
 */
abstract class BaseDirectoryPermission extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
  const PEER = 'DirectoryPermissionPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        DirectoryPermissionPeer
	 */
	...
	public function setFilename($v)
	{
		...
		if ($this->filename !== $v) {
			$this->filename = $v;
			$this->modifiedColumns[] = DirectoryPermissionPeer::FILENAME;
		}
	...
	public function setGroupId($v)
	{
		...
		if ($this->group_id !== $v) {
			$this->group_id = $v;
			$this->modifiedColumns[] = DirectoryPermissionPeer::GROUP_ID;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = DirectoryPermissionPeer::CREATED_BY;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = DirectoryPermissionPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = DirectoryPermissionPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = DirectoryPermissionPeer::NUM_COLUMNS - DirectoryPermissionPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating DirectoryPermission object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = DirectoryPermissionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				DirectoryPermissionQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				DirectoryPermissionPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		$pos = DirectoryPermissionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DirectoryPermissionPeer::ID)) $criteria->add(DirectoryPermissionPeer::ID, $this->id);
		if ($this->isColumnModified(DirectoryPermissionPeer::FILENAME)) $criteria->add(DirectoryPermissionPeer::FILENAME, $this->filename);
		if ($this->isColumnModified(DirectoryPermissionPeer::GROUP_ID)) $criteria->add(DirectoryPermissionPeer::GROUP_ID, $this->group_id);
		if ($this->isColumnModified(DirectoryPermissionPeer::CREATED_BY)) $criteria->add(DirectoryPermissionPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(DirectoryPermissionPeer::CREATED_AT)) $criteria->add(DirectoryPermissionPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(DirectoryPermissionPeer::UPDATED_AT)) $criteria->add(DirectoryPermissionPeer::UPDATED_AT, $this->updated_at);
	...
	{
		$criteria = new Criteria(DirectoryPermissionPeer::DATABASE_NAME);
		$criteria->add(DirectoryPermissionPeer::ID, $this->id);
		$criteria->add(DirectoryPermissionPeer::GROUP_ID, $this->group_id);
	...
	{
		return (null === $this->getId()) && (null === $this->getGroupId());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of DirectoryPermission (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     DirectoryPermission Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     DirectoryPermissionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new DirectoryPermissionPeer();
		}
		return self::$peer;
	}
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->created_by !== null)) {
			$this->aUser = UserQuery::create()->findPk($this->created_by);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUser->addDirectoryPermissions($this);
			 */
		}
		return $this->aUser;
	}
